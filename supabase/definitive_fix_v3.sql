-- ============================================================
-- LIFE COMPANION — DEFINITIVE DATABASE FIX v3
-- Run this ENTIRE script in Supabase SQL Editor → New Query
-- ============================================================

-- STEP 0: CREATE MISSING COLUMNS FIRST
-- This must happen before any inserts!
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS onboarding_complete BOOLEAN DEFAULT false;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS phone TEXT;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS district TEXT;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS phc_name TEXT;
...
LEFT JOIN public.patients pt ON pt.profile_id = p.id
...
-- STEP 4: Fix the role column type
DO $$
BEGIN
...
-- STEP 6: Verify
SELECT 'Database fix successfully completed!' as status;
